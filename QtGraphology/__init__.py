...
# -*- coding: utf-8 -*-
"""
**QtGraphology** is a node graph framework that can be implemented and re purposed
into applications that supports **PySide6**.

project: https://github.com/resmond/QtGraphology
...
.. code-block:: python
    ...
    from QtGraphology import QtWidgets, NodeGraph, BaseNode
    ...
    if __name__ == '__main__':
        ...
        backdrop = graph.create_node('QtGraphology.nodes.Backdrop', name='Backdrop')
        node_a = graph.create_node('io.github.resmond.MyNode', name='Node A')
        node_b = graph.create_node('io.github.resmond.MyNode', name='Node B', color='#5b162f')
