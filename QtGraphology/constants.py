...
__doc__ = """
| The :py:mod:`QtGraphology.constants` namespace contains variables and enums
 used throughout the QtGraphology library.
"""

# ================================== PRIVATE ===================================

MIME_TYPE = 'QtGraphology/nodes'
URI_SCHEME = 'QtGraphology://'
URN_SCHEME = 'QtGraphology::'
