...
if __name__ == '__main__':
    ...
    # Custom builtin widgets from QtGraphology
    # ---------------------------------------
    ...
    nodes_tree.set_category_label('QtGraphology.nodes', 'Builtin Nodes')
    ...
    nodes_palette.set_category_label('QtGraphology.nodes', 'Builtin Nodes')
